            ...
            <div className="flex flex-col lg:flex-row justify-between gap-8">
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col lg:items-end justify-center gap-4">
                <div className="px-6 py-4 bg-primary text-primary-foreground rounded-2xl shadow-lg shadow-primary/20 flex flex-col items-center sm:items-start lg:items-end">
                  <span className="text-2xl font-black">{new Date(slot.dateTime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
                  <span className="text-xs font-bold opacity-80 uppercase tracking-widest">{new Date(slot.dateTime).toLocaleDateString("en-US", { month: 'long', day: 'numeric', year: 'numeric' })}</span>
                </div>
